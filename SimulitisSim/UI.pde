public class UI{
  ...
  */
  public void display(int citySize){
    ...
    text("Day: " + dayCount, citySize * 0.05  , citySize - 25);
    
    // Replace the number 0 with an expression that contains the variable citSize
    text("Current Infections: " + infected, citySize*0.3
   
    , citySize - 25);
    
    text("Recovered: " + recovered, citySize * 0.6, citySize - 25);
    
    // Replace the number 0 with an expression that contains the variable citSize
    text("Dead: " + dead, citySize * 0.85
